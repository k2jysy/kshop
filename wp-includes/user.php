...
function wp_insert_user( $userdata ) {
	...
	/** Begin
	 * Insert user's wechat information
	 * @Auther Yang Si Yuan
	 */
	 
	$weixin_user_sex = empty( $userdata['weixin_user_sex'] ) ? '' : $userdata['weixin_user_sex'];
	$meta['weixin_user_sex'] = apply_filters( 'pre_user_weixin_user_sex', $weixin_user_sex );
	
	$weixin_user_city = empty( $userdata['weixin_user_city'] ) ? '' : $userdata['weixin_user_city'];
	$meta['weixin_user_city'] = apply_filters( 'pre_user_weixin_user_city', $weixin_user_city );
	
	$weixin_user_province = empty( $userdata['weixin_user_province'] ) ? '' : $userdata['weixin_user_province'];
	$meta['weixin_user_province'] = apply_filters( 'pre_user_weixin_user_province', $weixin_user_province );
	
	$weixin_user_country = empty( $userdata['weixin_user_country'] ) ? '' : $userdata['weixin_user_country'];
	$meta['weixin_user_country'] = apply_filters( 'pre_user_weixin_user_country', $weixin_user_country );
	
	$weixin_user_subscribe = empty( $userdata['weixin_user_subscribe'] ) ? '' : $userdata['weixin_user_subscribe'];
	$meta['weixin_user_subscribe'] = apply_filters( 'pre_user_weixin_user_subscribe', $weixin_user_subscribe );
