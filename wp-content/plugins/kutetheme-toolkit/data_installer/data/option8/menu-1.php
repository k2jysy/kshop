...
//Menu
$menu_id = kt_add_menu( 158, 'Categories', '' );

 // Menu Item
kt_add_menu_item( 1963, $menu_id, 0, 'Electronic', 'product_cat', 89, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/electronic/', '', '', '' );

kt_add_menu_item( 1964, $menu_id, 0, 'Sport & Outdoors', 'product_cat', 114, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/sport-outdoor/', '', '', '' );

kt_add_menu_item( 1965, $menu_id, 0, 'Smartphone & Tablets', 'product_cat', 113, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/digital/smartphone-tablets/', '', '', '' );

kt_add_menu_item( 1967, $menu_id, 0, 'Health & Beauty Bags', 'product_cat', 95, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/health-beauty-bags/', '', '', '' );

kt_add_menu_item( 1966, $menu_id, 0, 'Shoes & Accessories', 'product_cat', 111, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/shoes-accessories/', '', '', '' );

kt_add_menu_item( 1970, $menu_id, 0, 'Toys & Hobbies', 'product_cat', 122, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/toys-hobbies/', '', '', '' );

kt_add_menu_item( 1968, $menu_id, 0, 'Computers & Networking', 'product_cat', 140, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/digital/computers-networking/', '', '', '' );

kt_add_menu_item( 1969, $menu_id, 0, 'Jewelry & Watches', 'product_cat', 98, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/jewelry/jewelry-watches/', '', '', '' );

kt_add_menu_item( 1971, $menu_id, 0, 'Flashlights & Lamps', 'product_cat', 91, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/electronic/flashlights-lamps/', '', '', '' );

kt_add_menu_item( 1972, $menu_id, 0, 'Cameras & Photo', 'product_cat', 136, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/digital/cameras-photo/', '', '', '' );

kt_add_menu_item( 1973, $menu_id, 0, 'Television', 'product_cat', 118, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/digital/television-2/', '', '', '' );

kt_add_menu_item( 1974, $menu_id, 0, 'Fashion', 'product_cat', 90, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/', '', '', '' );

kt_add_menu_item( 1975, $menu_id, 0, 'Furniture', 'product_cat', 93, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/furniture/', '', '', '' );

kt_add_menu_item( 1976, $menu_id, 0, 'Health & Beauty', 'product_cat', 148, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/health-beauty-bags/health-beauty/', '', '', '' );
...
//Menu
$menu_id = kt_add_menu( 190, 'Footer menu', 'custom_footer_menu' );

 // Menu Item
kt_add_menu_item( 2095, $menu_id, 0, 'About Us', 'custom', 2095, 'custom', '#', '', '0', '' );

kt_add_menu_item( 2096, $menu_id, 0, 'Affiliates', 'custom', 2096, 'custom', '#', '', '0', '' );

kt_add_menu_item( 2097, $menu_id, 0, 'Careers', 'custom', 2097, 'custom', '#', '', '0', '' );

kt_add_menu_item( 2098, $menu_id, 0, 'Privacy Policy', 'custom', 2098, 'custom', '#', '', '0', '' );

kt_add_menu_item( 2099, $menu_id, 0, 'Terms', 'custom', 2099, 'custom', '#', '', '0', '' );
...
$menu_id = kt_add_menu( 171, 'Main menu', 'primary' );
 ...
 // Menu Item
kt_add_menu_item( 1994, $menu_id, 0, 'Home', 'page', 347, 'post_type', 'http://kutethemes.net/wordpress/kuteshop/option8/', '', '0', '' );
...
kt_add_menu_item( 1889, $menu_id, 0, 'Fashion', 'product_cat', 90, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/', 'enabled', '55', '' );

kt_add_menu_item( 1890, $menu_id, 0, 'Foods', 'product_cat', 92, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/foods/', 'enabled', '835', '' );

kt_add_menu_item( 1891, $menu_id, 0, 'Sports', 'product_cat', 115, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/sport-outdoor/sports/', '', '0', '' );

kt_add_menu_item( 1892, $menu_id, 0, 'Digital', 'product_cat', 88, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/digital/', '', '0', '' );
...
kt_add_menu_item( 1893, $menu_id, 0, 'Furniture', 'product_cat', 93, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/furniture/', '', '0', '' );

kt_add_menu_item( 1894, $menu_id, 0, 'Jewelry', 'product_cat', 97, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/jewelry/', '', '0', '' );

kt_add_menu_item( 1993, $menu_id, 0, 'Blog', 'page', 1188, 'post_type', 'http://kutethemes.net/wordpress/kuteshop/option8/sample-page-2/', '', '0', '' );

//Menu
$menu_id = kt_add_menu( 172, 'Men&#039;s', '' );

 // Menu Item
kt_add_menu_item( 1868, $menu_id, 0, 'Jackets', 'product_cat', 150, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/mens/jackets/', '', '', '' );

kt_add_menu_item( 1869, $menu_id, 0, 'Skirts', 'product_cat', 112, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/mens/skirts/', '', '', '' );

kt_add_menu_item( 1870, $menu_id, 0, 'Tops', 'product_cat', 121, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/mens/tops/', '', '', '' );

kt_add_menu_item( 1995, $menu_id, 0, 'Scarves', 'product_cat', 110, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/scarves/', '', '', '' );

kt_add_menu_item( 1996, $menu_id, 0, 'T_Shirt', 'product_cat', 117, 'taxonomy', 'http://kutethemes.net/wordpress/kuteshop/option8/product-category/fashion/t_shirt/', '', '', '' );
...
//Menu
$menu_id = kt_add_menu( 186, 'Topbar menu left', 'topbar_menuleft' );

 // Menu Item
kt_add_menu_item( 2014, $menu_id, 0, '<i class=\"fa fa-phone\"></i> +00 123 456 789', 'custom', 2014, 'custom', '#', '', '0', '' );

kt_add_menu_item( 2015, $menu_id, 0, '<i class=\"fa fa-envelope\"></i> Contact us today !', 'custom', 2015, 'custom', '#', '', '0', '' );

//Menu
$menu_id = kt_add_menu( 187, 'Topbar menu right', 'topbar_menuright' );

 // Menu Item
kt_add_menu_item( 2016, $menu_id, 0, 'Support', 'page', 371, 'post_type', 'http://kutethemes.net/wordpress/kuteshop/option8/support/', '', '0', '' );

kt_add_menu_item( 2017, $menu_id, 0, 'Services', 'page', 369, 'post_type', 'http://kutethemes.net/wordpress/kuteshop/option8/services/', '', '0', '' );
