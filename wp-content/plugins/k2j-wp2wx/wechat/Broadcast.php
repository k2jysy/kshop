...
class Broadcast {
    ...
    ?>
        <div class="wrap">
                ...
                <form method="post" action="options.php">
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="wechat_secret">特定用户微信号</label></th>
                                <td>
            ...
            <div style="float: left;">
                <h2>版权所有</h2>
                <p><img src="http://www.i-traveled.org/wp-content/uploads/2016/12/siyuan.png" width="315" height="148" alt=""/></p>
                <ul>
                  <li>1.思远工作室版权所有;</li>
                    <li>2.定制开发请联系思远：asysydd@gmail.com;</li>
                    <li>3.使用许可购买：$500;</li>
                    <li>4.付费Paypal账户: asysydd@gmail.com;</li>
                </ul>
            </div>
        </div>
    <?php
    ...
    public function new_meta_box()
    {
        ...
        echo '<input type="radio" name="wechat_push_switch" value="preview" id="preview"/><label for="preview">微信特定用户</label>';
