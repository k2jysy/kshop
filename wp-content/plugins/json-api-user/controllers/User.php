...
$allowed_params = array('user_login', 'user_email', 'user_pass', 'display_name', 'user_nicename', 'user_url', 'nickname', 'first_name',
						 ...
						 'comment_shortcuts', 'admin_color', 'use_ssl', 'show_admin_bar_front', 'weixin_user_sex', 'weixin_user_city', 
						 
						 'weixin_user_province' , 'weixin_user_country', 'weixin_user_subscribe'
